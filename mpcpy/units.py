# -*- coding: utf-8 -*-
"""
``units`` classes work together with ``variables`` classes to form the 
fundamental building blocks of data management in MPCPy.  Please see the 
...
class _DisplayUnit(object):
    ...
    def _define_quantity(self):
        '''Define the quantity name and base unit of the display unit.
    ...
    def _define_display_unit(self):
        '''Define the name of the display unit.
    ...
    def _convert_to_base(self):
        '''Convert the data from the display unit to the base unit.
    ...
    def _convert_from_base(self):
        '''Convert the data from the base unit to the display unit.
...
class _Boolean(_DisplayUnit):
    '''Mixin class for Boolean units.
    
    '''
    
    def _define_quantity(self, variable):
        '''Defines the class as a Boolean quantity.
...
class _Temperature(_DisplayUnit):
    '''Mixin class for Temperature units.
    
    '''
    
    def _define_quantity(self, variable):
        '''Defines the class as a Temperature quantity.
...
class _Power(_DisplayUnit):
    '''Mixin class for Power units.
    
    '''  
    
    def _define_quantity(self, variable):
        '''Defines the class as a Power quantity.
...
class _Energy(_DisplayUnit):
    '''Mixin class for Energy units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as an Energy quantity.
...
class _PowerFlux(_DisplayUnit):
    '''Mixin class for PowerFlux units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a PowerFlux quantity.
...
class _EnergyIntensity(_DisplayUnit):
    '''Mixin class for EnergyIntensity units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as an EnergyIntensity quantity.
...
class _Pressure(_DisplayUnit):
    '''Mixin class for Pressure units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a Pressure quantity.
...
class _DimensionlessRatio(_DisplayUnit):
    '''Mixin class for DimensionlessRatio units.
    
    '''
    def _define_quantity(self, variable):
        '''Defines the class as a DimensionlessRatio quantity.
...
class _Angle(_DisplayUnit):
    '''Mixin class for Angle units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as an Angle quantity.
...
class _Time(_DisplayUnit):
    '''Mixin class for Time units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a Time quantity.
...
class _Mass(_DisplayUnit):
    '''Mixin class for Mass units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a Mass quantity.
...
class _Length(_DisplayUnit):
    '''Mixin class for Length units.
    
    '''
    
    def _define_quantity(self, variable):
        '''Defines the class as a Length quantity.
...
class _Area(_DisplayUnit):
    '''Mixin class for Area units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as an Area quantity.
...
class _Volume(_DisplayUnit):
    '''Mixin class for Volume units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a Volume quantity.
...
class _MassFlow(_DisplayUnit):
    '''Mixin class for MassFlow units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a MassFlow quantity.
...
class _VolumetricFlow(_DisplayUnit):
    '''Mixin class for VolumetricFlow units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a VolumetricFlow quantity.
...
class _Velocity(_DisplayUnit):
    '''Mixin class for Velocity units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a Velocity quantity.
...
class _Illuminance(_DisplayUnit):
    '''Mixin class for Illuminance units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as an Illuminance quantity.
...
class _Luminance(_DisplayUnit):
    '''Mixin class for Luminance units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a Luminance quantity.
...
class _EnergyPrice(_DisplayUnit):
    '''Mixin class for EnergyPrice units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as an EnergyPrice quantity.
...
class _PowerPrice(_DisplayUnit):
    '''Mixin class for PowerPrice units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a PowerPrice quantity.
...
class _SpecificHeatCapacity(_DisplayUnit):
    '''Mixin class for SpecificHeatCapacity units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a SpecificHeatCapacity quantity.
...
class _HeatCapacity(_DisplayUnit):
    '''Mixin class for HeatCapacity units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a HeatCapacity quantity.
...
class _HeatCapacityCoefficient(_DisplayUnit):
    '''Mixin class for HeatCapacityCoefficient units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a HeatCapacityCoefficient quantity.
...
class _HeatResistance(_DisplayUnit):
    '''Mixin class for HeatResistance units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a HeatResistance quantity.
...
class _HeatResistanceCoefficient(_DisplayUnit):
    '''Mixin class for HeatResistanceCoefficient units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a HeatResistanceCoefficient quantity.
...
class _HeatTransferCoefficient(_DisplayUnit):
    '''Mixin class for HeatTransferCoefficient units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a HeatTransferCoefficient quantity.
...
class _Density(_DisplayUnit):
    '''Mixin class for Density units.
    
    '''

    def _define_quantity(self, variable):
        '''Defines the class as a Density quantity.
